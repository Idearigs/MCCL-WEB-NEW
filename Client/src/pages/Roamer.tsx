...
const Roamer = (): JSX.Element => {
  ...
  useEffect(() => {
    const fetchCollections = async () => {
      try {
        setLoading(true);
        const response = await fetch(`${API_BASE_URL}/watches/brands/slug/roamer/collections`);
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          <div className="mb-12 group">
            <div className="relative inline-block">
              <img
                src="/images/roamer-logo.png"
                alt="Roamer Logo"
                className="h-20 md:h-28 mx-auto brightness-0 transition-all duration-700 group-hover:scale-110 animate-fade-in-up opacity-0"
          ...
          <div className="space-y-6 animate-fade-in-up opacity-0" style={{animationDelay: '0.8s', animationFillMode: 'forwards'}}>
            <div className="relative">
              <p className="text-sm md:text-base font-inter font-light text-red-900 uppercase tracking-[0.3em] mb-2">Since 1888</p>
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-center">
            ...
            <div className="flex-1 space-y-6">
              <div>
                <p className="text-xs font-inter font-light text-red-900 uppercase tracking-[0.3em] mb-4">
                  Featured Collection
                </p>
            ...
            <div className="relative w-full lg:w-96 h-96 flex-shrink-0 bg-white overflow-hidden group">
              <div className="absolute inset-0 flex items-center justify-center">
                <img
                  ...
                  alt={featuredCollection.preview_watch_name || 'Roamer Watch'}
