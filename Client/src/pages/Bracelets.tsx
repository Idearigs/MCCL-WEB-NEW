...
const Bracelets = (): JSX.Element => {
  const [likedProducts, setLikedProducts] = useState<Set<number>>(new Set());
  const [activeFilter, setActiveFilter] = useState<string | null>(null);
  const [selectedCategory, setSelectedCategory] = useState<string>('bracelets');
  ...
  // Bracelet-specific filter options
  const filterOptions = {
    price: [
      'Under £500',
      '£500 - £1,000',
        ...
        <div className="w-full px-4 lg:px-[40px]">
          ...
          <nav className="mb-3 lg:mb-8">
            <div className="flex items-center text-sm text-gray-500 font-light">
              ...
              <span className="mx-2">→</span>
              <span className="text-gray-900">Bracelets</span>
            </div>
          </nav>
          ...
          <div className="mb-10 lg:mb-12">
            ...
            <div className="max-w-2xl">
              <p className="text-base lg:text-base text-gray-700 leading-relaxed mb-4 lg:mb-4 font-cormorant">
                Adorn your wrists with our exquisite collection of bracelets, from delicate tennis bracelets 
                to bold statement cuffs. Each piece is meticulously crafted with precious gemstones and metals, 
                designed to complement your personal style with sophistication and grace.
              </p>
          ...
          <div className="mb-6 lg:mb-8 pb-4 lg:pb-6 border-b border-gray-200 relative">
            ...
            <div className="lg:hidden">
              <div className="flex overflow-x-auto gap-6 pb-2 scrollbar-hide">
                ...
                <button 
                  onClick={() => setSelectedCategory('cuff')}
                  className={`flex-shrink-0 text-sm font-inter uppercase tracking-wider whitespace-nowrap transition-colors ${
                    selectedCategory === 'cuff' 
                      ? 'font-medium text-gray-900' 
                      : 'font-light text-gray-500 hover:text-gray-700'
                  }`}
                >
                ...
                <button 
                  onClick={() => setSelectedCategory('bangle')}
                  className={`flex-shrink-0 text-sm font-inter uppercase tracking-wider whitespace-nowrap transition-colors ${
                    selectedCategory === 'bangle' 
                      ? 'font-medium text-gray-900' 
                      : 'font-light text-gray-500 hover:text-gray-700'
                  }`}
                >
            ...
            <div className="hidden lg:flex flex-wrap items-center justify-between gap-4">
              <div className="flex flex-wrap items-center gap-6 text-sm font-inter relative">
                ...
                <div className="relative">
                  <button 
                    onClick={() => toggleFilter('braceletType')}
                    className={`text-gray-700 hover:text-gray-900 uppercase tracking-wider font-light transition-colors flex items-center gap-1 ${
                      activeFilter === 'braceletType' ? 'text-gray-900' : ''
                    }`}
                  >
                    Bracelet Type
                    <svg className={`w-3 h-3 transition-transform ${activeFilter === 'braceletType' ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 9l-7 7-7-7"/>
                    </svg>
                  </button>
                  {activeFilter === 'braceletType' && (
                    <div className="absolute top-full left-0 mt-3 w-64 bg-white border border-gray-200 shadow-xl rounded-none z-50 animate-fade-in">
                      <div className="p-6">
                        <h3 className="text-xs font-medium text-gray-900 uppercase tracking-wider mb-4 font-inter">Bracelet Type</h3>
                        <div className="space-y-3">
                          {filterOptions.braceletType.map((option, index) => (
                            <label key={index} className="flex items-center group cursor-pointer">
                              <input 
                                type="checkbox" 
                                className="w-3 h-3 border border-gray-300 rounded-none bg-white checked:bg-gray-900 checked:border-gray-900 transition-colors" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-16">
            ...
            <div className="group cursor-pointer bg-white transition-all duration-300">
              <div className="relative bg-gray-50 overflow-hidden mx-2 lg:mx-4" style={{ aspectRatio: '0.8', height: 'auto' }}>
                ...
                <img 
                  ...
                  alt="Diamond Tennis Bracelet - Alternative View"
              ...
              <div className="p-4">
                <h3 className="text-base font-cormorant font-normal text-gray-700 mb-3 leading-tight">Diamond Tennis Bracelet</h3>
                <p className="text-lg font-cormorant font-medium text-gray-600">£4,800</p>
            ...
            <div className="group cursor-pointer bg-white transition-all duration-300">
              <div className="relative bg-gray-50 overflow-hidden mx-2 lg:mx-4" style={{ aspectRatio: '0.8', height: 'auto' }}>
                ...
                <img 
                  ...
                  alt="Rose Gold Chain Bracelet - Alternative View"
                  className="absolute inset-0 w-full h-full object-cover transition-opacity duration-300 opacity-0 group-hover:opacity-100"
                />
              ...
              <div className="p-4">
                <h3 className="text-base font-cormorant font-normal text-gray-700 mb-3 leading-tight">Rose Gold Chain Bracelet</h3>
                <p className="text-lg font-cormorant font-medium text-gray-600">£1,200</p>
            ...
            <div className="group cursor-pointer bg-white transition-all duration-300">
              <div className="relative bg-gray-50 overflow-hidden mx-2 lg:mx-4" style={{ aspectRatio: '0.8', height: 'auto' }}>
                ...
                <img 
                  ...
                  alt="Pearl Strand Bracelet - Alternative View"
                  className="absolute inset-0 w-full h-full object-cover transition-opacity duration-300 opacity-0 group-hover:opacity-100"
                />
              ...
              <div className="p-4">
                <h3 className="text-base font-cormorant font-normal text-gray-700 mb-3 leading-tight">Pearl Strand Bracelet</h3>
                <p className="text-lg font-cormorant font-medium text-gray-600">£950</p>
                <p className="text-sm text-gray-500 font-cormorant">Freshwater Pearls</p>
              </div>
            </div>
            ...
            <div className="group cursor-pointer bg-white transition-all duration-300">
              <div className="relative bg-gray-50 overflow-hidden mx-2 lg:mx-4" style={{ aspectRatio: '0.8', height: 'auto' }}>
                ...
                <img 
                  src="/images/Diamonds.jpg" 
                  alt="Sapphire Link Bracelet - Alternative View"
                  className="absolute inset-0 w-full h-full object-cover transition-opacity duration-300 opacity-0 group-hover:opacity-100"
                />
              ...
              <div className="p-4">
                <h3 className="text-base font-cormorant font-normal text-gray-700 mb-3 leading-tight">Sapphire Link Bracelet</h3>
                <p className="text-lg font-cormorant font-medium text-gray-600">£3,200</p>
                <p className="text-sm text-gray-500 font-cormorant">White Gold & Sapphires</p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center bg-gray-50 rounded-lg p-12">
            ...
            <p className="text-lg text-gray-600 mb-8 font-cormorant">
              From delicate everyday pieces to bold statement bracelets, find the perfect finishing touch for your personal style in our curated collection.
            </p>
