...
const Bracelets = (): JSX.Element => {
  ...
  useEffect(() => {
    localStorage.setItem('lastShoppingCategory', 'bracelets');
  }, []);
    ...
    const fetchData = async () => {
      try {
        ...
        const [
          ...
          fetch(`${API_BASE_URL}/products/category/bracelets`),
        ...
        if (productsData.success) {
          ...
          setError(productsData.message || 'Failed to fetch bracelet products');
        }
        ...
        setError('Failed to fetch bracelet products');
        ...
        <div className="w-full px-4 lg:px-[40px]">
          ...
          <div className="mb-10 lg:mb-12">
            ...
            <div className="max-w-2xl">
              <p className="text-base lg:text-base text-gray-700 leading-relaxed mb-4 lg:mb-4 font-cormorant">
                Explore our stunning collection of bracelets, from elegant tennis bracelets to bold statement cuffs.
                Each piece is expertly crafted with precious metals and gemstones, designed to adorn your wrist with
                timeless beauty and exquisite craftsmanship.
              </p>
            ...
            {loading ? (
              ...
              <div className="col-span-full text-center py-12 text-gray-500">
                ...
                <p className="text-gray-600 mb-6">
                  Try adjusting your filter selections to see more bracelets.
                </p>
                <button
                  onClick={clearFilters}
              ...
              <div className="col-span-full text-center py-12 text-gray-500">
                <h3 className="text-xl font-cormorant font-normal text-gray-700 mb-4">
                  Bracelet Products Coming Soon
                </h3>
                <p className="text-gray-600 mb-6">
                  We're currently setting up our bracelet collection database. Please check back soon to see our beautiful selection of bracelets.
                </p>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      <p className="text-sm text-gray-500 font-cormorant">{product.description || 'Exquisite Bracelet'}</p>
                    </div>
                  </Link>
                );
              })
          ...
          <div className="text-center bg-gray-50 rounded-lg p-12">
            ...
            <p className="text-lg text-gray-600 mb-8 font-cormorant">
              From elegant classics to bold statement pieces, our bracelet collection offers sophistication and style for every occasion.
            </p>
