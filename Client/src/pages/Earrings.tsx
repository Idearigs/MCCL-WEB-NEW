    ...
    const fetchData = async () => {
      try {
        ...
        const [
          ...
          fetch(`${API_BASE_URL}/products/category/earrings?limit=500`),
        ...
        setError('Failed to fetch earring products');
          ...
          <div className="mb-10 lg:mb-12">
            ...
            <div className="max-w-2xl">
              <p className="text-base lg:text-base text-gray-700 leading-relaxed mb-4 lg:mb-4 font-cormorant">
                Discover our sophisticated collection of earrings, from elegant diamond studs to statement chandelier pieces.
                Each pair is carefully designed to frame your face beautifully, crafted with the finest gemstones and precious
                metals for timeless elegance and exceptional quality.
              </p>
            ...
            {loading ? (
              ...
              <div className="col-span-full text-center py-12 text-gray-500">
                <h3 className="text-xl font-cormorant font-normal text-gray-700 mb-4">
                  No earrings match your filters
                </h3>
                <p className="text-gray-600 mb-6">
                  Try adjusting your filter selections to see more earrings.
                </p>
                <button
                  onClick={clearFilters}
              ...
              <div className="col-span-full text-center py-12 text-gray-500">
                <h3 className="text-xl font-cormorant font-normal text-gray-700 mb-4">
                  Earring Products Coming Soon
                </h3>
                <p className="text-gray-600 mb-6">
                  We're currently setting up our earring collection database. Please check back soon to see our beautiful selection of earrings.
                </p>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      <p className="text-sm text-gray-500 font-cormorant">{product.description || 'Exquisite Earrings'}</p>
                    </div>
                  </Link>
                );
              })
