...
const FestinaClassicCollection = (): JSX.Element => {
  ...
  useEffect(() => {
    const fetchCollectionData = async () => {
      try {
        setLoading(true);
        const response = await fetch('http://localhost:5000/api/v1/watches/collections/festina-classic-collection');
...
export default FestinaClassicCollection;
