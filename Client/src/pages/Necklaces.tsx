    ...
    const fetchData = async () => {
      try {
        ...
        if (productsData.success) {
          ...
          setError(productsData.message || 'Failed to fetch necklace products');
        }
        ...
        setError('Failed to fetch necklace products');
        ...
        <div className="w-full px-4 lg:px-[40px]">
          ...
          <div className="mb-10 lg:mb-12">
            ...
            <div className="max-w-2xl">
              <p className="text-base lg:text-base text-gray-700 leading-relaxed mb-4 lg:mb-4 font-cormorant">
                Explore our exquisite collection of necklaces, from delicate pendants to stunning statement pieces.
                Each necklace is meticulously crafted with the finest gemstones and precious metals, designed to
                complement your natural beauty with timeless elegance and sophistication.
              </p>
            ...
            {loading ? (
              ...
              <div className="col-span-full text-center py-12 text-gray-500">
                <h3 className="text-xl font-cormorant font-normal text-gray-700 mb-4">
                  No necklaces match your filters
                </h3>
                <p className="text-gray-600 mb-6">
                  Try adjusting your filter selections to see more necklaces.
                </p>
                <button
                  onClick={clearFilters}
              ...
              <div className="col-span-full text-center py-12 text-gray-500">
                <h3 className="text-xl font-cormorant font-normal text-gray-700 mb-4">
                  Necklace Products Coming Soon
                </h3>
                <p className="text-gray-600 mb-6">
                  We're currently setting up our necklace collection database. Please check back soon to see our beautiful selection of necklaces.
                </p>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      <p className="text-sm text-gray-500 font-cormorant">{product.description || 'Exquisite Necklace'}</p>
                    </div>
                  </Link>
                );
              })
          ...
          <div className="text-center bg-gray-50 rounded-lg p-12">
            ...
            <p className="text-lg text-gray-600 mb-8 font-cormorant">
              From delicate pendants to statement pieces, our necklace collection offers sophistication and elegance for every occasion.
            </p>
