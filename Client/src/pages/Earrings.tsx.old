...
const Earrings = (): JSX.Element => {
  ...
  // Earring-specific filter options
  const filterOptions = {
    price: [
      'Under £500',
      '£500 - £1,000',
        ...
        <div className="w-full px-4 lg:px-[40px]">
          ...
          <div className="mb-10 lg:mb-12">
            ...
            <div className="max-w-2xl">
              <p className="text-base lg:text-base text-gray-700 leading-relaxed mb-4 lg:mb-4 font-cormorant">
                Discover our sophisticated collection of earrings, from elegant diamond studs to 
                statement chandelier pieces. Each pair is carefully designed to frame your face beautifully, 
                crafted with the finest gemstones and precious metals for timeless elegance.
              </p>
          ...
          <div className="mb-6 lg:mb-8 pb-4 lg:pb-6 border-b border-gray-200 relative">
            ...
            <div className="lg:hidden">
              <div className="flex overflow-x-auto gap-6 pb-2 scrollbar-hide">
                ...
                <button 
                  onClick={() => setSelectedCategory('stud')}
                  className={`flex-shrink-0 text-sm font-inter uppercase tracking-wider whitespace-nowrap transition-colors ${
                ...
                <button 
                  onClick={() => setSelectedCategory('hoop')}
                  className={`flex-shrink-0 text-sm font-inter uppercase tracking-wider whitespace-nowrap transition-colors ${
                    selectedCategory === 'hoop' 
                      ? 'font-medium text-gray-900' 
                      : 'font-light text-gray-500 hover:text-gray-700'
                  }`}
                >
                ...
                <button 
                  onClick={() => setSelectedCategory('chandelier')}
                  className={`flex-shrink-0 text-sm font-inter uppercase tracking-wider whitespace-nowrap transition-colors ${
                    selectedCategory === 'chandelier' 
                      ? 'font-medium text-gray-900' 
                      : 'font-light text-gray-500 hover:text-gray-700'
                  }`}
                >
            ...
            <div className="hidden lg:flex flex-wrap items-center justify-between gap-4">
              <div className="flex flex-wrap items-center gap-6 text-sm font-inter relative">
                ...
                <div className="relative">
                  <button 
                    onClick={() => toggleFilter('earringType')}
                    className={`text-gray-700 hover:text-gray-900 uppercase tracking-wider font-light transition-colors flex items-center gap-1 ${
                      activeFilter === 'earringType' ? 'text-gray-900' : ''
                    }`}
                  >
                    Earring Type
                    <svg className={`w-3 h-3 transition-transform ${activeFilter === 'earringType' ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 9l-7 7-7-7"/>
                    </svg>
                  </button>
                  {activeFilter === 'earringType' && (
                    <div className="absolute top-full left-0 mt-3 w-64 bg-white border border-gray-200 shadow-xl rounded-none z-50 animate-fade-in">
                      <div className="p-6">
                        <h3 className="text-xs font-medium text-gray-900 uppercase tracking-wider mb-4 font-inter">Earring Type</h3>
                        <div className="space-y-3">
                          {filterOptions.earringType.map((option, index) => (
                            <label key={index} className="flex items-center group cursor-pointer">
                              <input 
                                type="checkbox" 
                                className="w-3 h-3 border border-gray-300 rounded-none bg-white checked:bg-gray-900 checked:border-gray-900 transition-colors" 
                ...
                <div className="relative">
                  <button 
                    ...
                    className={`text-gray-700 hover:text-gray-900 uppercase tracking-wider font-light transition-colors flex items-center gap-1 ${
                      activeFilter === 'style' ? 'text-gray-900' : ''
                    }`}
                  >
                    Style
                    <svg className={`w-3 h-3 transition-transform ${activeFilter === 'style' ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 9l-7 7-7-7"/>
                    </svg>
                  </button>
                  {activeFilter === 'style' && (
                    <div className="absolute top-full left-0 mt-3 w-64 bg-white border border-gray-200 shadow-xl rounded-none z-50 animate-fade-in">
                      <div className="p-6">
                        <h3 className="text-xs font-medium text-gray-900 uppercase tracking-wider mb-4 font-inter">Style</h3>
                        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-16">
            ...
            <div className="group cursor-pointer bg-white transition-all duration-300">
              <div className="relative bg-gray-50 overflow-hidden mx-2 lg:mx-4" style={{ aspectRatio: '0.8', height: 'auto' }}>
                ...
                <img 
                  ...
                  alt="Diamond Drop Earrings - Alternative View"
              ...
              <div className="p-4">
                <h3 className="text-base font-cormorant font-normal text-gray-700 mb-3 leading-tight">Diamond Drop Earrings</h3>
                <p className="text-lg font-cormorant font-medium text-gray-600">£2,100</p>
                <p className="text-sm text-gray-500 font-cormorant">White Gold & Diamonds</p>
              </div>
            </div>
            ...
            <div className="group cursor-pointer bg-white transition-all duration-300">
              <div className="relative bg-gray-50 overflow-hidden mx-2 lg:mx-4" style={{ aspectRatio: '0.8', height: 'auto' }}>
                ...
                <img 
                  ...
                  alt="Pearl Stud Earrings - Alternative View"
                  className="absolute inset-0 w-full h-full object-cover transition-opacity duration-300 opacity-0 group-hover:opacity-100"
                />
              ...
              <div className="p-4">
                <h3 className="text-base font-cormorant font-normal text-gray-700 mb-3 leading-tight">Pearl Stud Earrings</h3>
                <p className="text-lg font-cormorant font-medium text-gray-600">£750</p>
                <p className="text-sm text-gray-500 font-cormorant">South Sea Pearls</p>
              </div>
            </div>
            ...
            <div className="group cursor-pointer bg-white transition-all duration-300">
              <div className="relative bg-gray-50 overflow-hidden mx-2 lg:mx-4" style={{ aspectRatio: '0.8', height: 'auto' }}>
                ...
                <img 
                  src="/images/Wedding.jpg" 
                  alt="Sapphire Chandelier Earrings"
                  className="w-full h-full object-cover transition-opacity duration-300 group-hover:opacity-0"
                />
                ...
                <img 
                  ...
                  alt="Sapphire Chandelier Earrings - Alternative View"
                  className="absolute inset-0 w-full h-full object-cover transition-opacity duration-300 opacity-0 group-hover:opacity-100"
                />
              ...
              <div className="p-4">
                <h3 className="text-base font-cormorant font-normal text-gray-700 mb-3 leading-tight">Sapphire Chandelier Earrings</h3>
                <p className="text-lg font-cormorant font-medium text-gray-600">£3,800</p>
                <p className="text-sm text-gray-500 font-cormorant">Rose Gold & Sapphires</p>
              </div>
            </div>
            ...
            <div className="group cursor-pointer bg-white transition-all duration-300">
              <div className="relative bg-gray-50 overflow-hidden mx-2 lg:mx-4" style={{ aspectRatio: '0.8', height: 'auto' }}>
                ...
                <img 
                  src="/images/Jewellery.jpg" 
                  alt="Gold Hoop Earrings - Alternative View"
                  className="absolute inset-0 w-full h-full object-cover transition-opacity duration-300 opacity-0 group-hover:opacity-100"
                />
              ...
              <div className="p-4">
                <h3 className="text-base font-cormorant font-normal text-gray-700 mb-3 leading-tight">Gold Hoop Earrings</h3>
          ...
          <div className="text-center bg-gray-50 rounded-lg p-12">
            <h2 className="text-3xl font-light text-gray-900 mb-4 font-cormorant">
              Discover Your Perfect Earrings
            </h2>
            <p className="text-lg text-gray-600 mb-8 font-cormorant">
              From everyday elegance to statement pieces for special occasions, our earring collection offers timeless beauty for every moment.
            </p>
