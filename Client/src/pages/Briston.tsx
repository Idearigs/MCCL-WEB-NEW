      ...
      <div className="relative bg-white py-32 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-base font-inter font-light text-gray-600 leading-relaxed">
                  Briston's collection blends British heritage with modern design, creating distinctive timepieces that stand out with their contemporary style and innovative craftsmanship.
                </p>
              </div>
            ...
            <div className="relative h-[500px] bg-gradient-to-br from-blue-50 to-indigo-100 overflow-hidden group">
