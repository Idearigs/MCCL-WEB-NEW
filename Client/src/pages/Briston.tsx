  ...
  return (
    <div className="flex flex-col w-full bg-white min-h-screen">
      ...
      <div className="relative h-screen bg-black overflow-hidden">
        ...
        >
          <source src="/videos/briston.mp4" type="video/mp4" />
        </video>
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="space-y-6 animate-fade-in-up opacity-0" style={{animationDelay: '0.8s', animationFillMode: 'forwards'}}>
            <div className="relative">
              <p className="text-sm md:text-base font-inter font-light text-gray-900 uppercase tracking-[0.3em] mb-2">Since 2013</p>
            ...
            <p className="text-xs md:text-sm font-inter font-light text-gray-600 tracking-[0.2em] max-w-2xl mx-auto leading-relaxed">
              Contemporary British heritage meets modern design excellence
            </p>
          </div>
      ...
      <div className="relative bg-gray-50 py-24 overflow-x-hidden">
        <div className="max-w-7xl mx-auto md:px-6">
          <h2 className="text-4xl md:text-5xl font-thin font-cormorant mb-20 text-center px-6 text-gray-900">
            Our Collections
          </h2>
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-center">
            ...
            <div className="flex-1 space-y-6">
              <div>
                <p className="text-xs font-inter font-light text-gray-900 uppercase tracking-[0.3em] mb-4">
                  Featured Collection
                </p>
            ...
            <div className="relative w-full lg:w-96 h-96 flex-shrink-0 bg-white overflow-hidden group">
              <div className="absolute inset-0 flex items-center justify-center">
                <img
                  ...
                  alt={featuredCollection.preview_watch_name || 'Briston Watch'}
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-center mt-16">
            ...
            <div className="flex-1 space-y-6 order-2 text-center lg:text-left">
              <div>
                ...
                <p className="text-base font-inter font-light text-gray-600 leading-relaxed">
                  We have put together a few tips and tricks in order to ensure that you always know exactly how to care for your watch, whether that be regular servicing by a Briston trained and certified watchmaker, or a little bit of gentle at-home maintenance.
                </p>
              </div>
      ...
      <div className="bg-gradient-to-br from-gray-50 to-white py-24">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="space-y-8 text-gray-700 font-inter font-light leading-relaxed">
            <p className="text-lg">
              McCulloch Jewellers and Briston share a passion for contemporary design and exceptional quality. As an authorized retailer, we're proud to showcase Briston's unique blend of British heritage and modern aesthetics.
            </p>
            <p className="text-lg">
              As a Briston authorised retailer, McCulloch Jewellers carry the distinctive timepieces created by this innovative British brand. With a commitment to contemporary style and lasting quality, McCulloch Jewellers and Briston continue to deliver exceptional watches to discerning collectors.
            </p>
          </div>
        </div>
      </div>
